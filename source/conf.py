# -*- coding: utf-8 -*-
#
# Scala TDD documentation build configuration file, created by
...
# exclude_trees is removed in Sphinx 1.3.
...
html_theme_options = {
    ...
    'navbar_title': "Test-Driven Development in Scala",
